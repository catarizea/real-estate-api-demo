...
import { FeatureToItemPayload, RabbitMqMessage } from '@/types';

const featureWorker = async (
  ...
  const { features, unitIds } = rabbitMqMessage.payload as FeatureToItemPayload;
